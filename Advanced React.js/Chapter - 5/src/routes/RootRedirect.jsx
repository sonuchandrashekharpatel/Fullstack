...
Type            Custom React Hook                   React Component

Where to use    Functions, Event Handlers,          Inside JSX return (...)
.               useEffect    

Style           Imperative ("Do this action now")   Declarative ("If condition met, render this redirect")

Best For        Form submits, button clicks,        Protected routes, auth redirects, layout guards
.               async flows                     
