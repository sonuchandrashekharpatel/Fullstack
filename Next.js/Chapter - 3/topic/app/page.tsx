...
/* 
Section 3: How data flows through a Next app
...
How data flows through a Next.js App
    . Setting up a local database
    . Fetching data from database
    . Rendering data in the UI
    . Making the app interactive
        . (Seaching, Sorting, Pagination)
    . Understading how it all fits together
